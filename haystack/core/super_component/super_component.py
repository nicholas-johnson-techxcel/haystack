...
class SuperComponent(_SuperComponent):
    ...
    def from_dict(cls, data: dict[str, Any]) -> "SuperComponent":
        ...
        """
        pipeline: Pipeline = Pipeline.from_dict(data["init_parameters"]["pipeline"])
        data["init_parameters"]["pipeline"] = pipeline
        return default_from_dict(cls, data)


def super_component[T: type](cls: T) -> T:
    """
    ...
    def init_wrapper(self, *args: Any, **kwargs: Any):
    ...
    def copy_class_namespace(namespace: dict[str, Any]):
